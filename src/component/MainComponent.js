...
class MainComponent extends React.Component {
    ...
    //   requests.put("https://uat.onplanapp.com/api/companies/updateCompany", company),
    // deleteCompany: (id) => requests.del("/api/companies/" + id),
    ...
    handleLoginAPI = async () => {
        if (this.state.email != '' && this.state.password != ''){
            await axios({
                method: 'post',
                url: 'https://uat.onplanapp.com/api/auth/signin',
                headers: {
    ...
    getCompanyList = async () => {
        ...
        await axios({
            method: 'get',
            url: 'https://uat.onplanapp.com/api/user/findUserCompanyList?userId=1&isImpersonate=false',
            headers:{
                'Accept': 'application/json',
    ...
    handleDashboardAccess = async () => {
        ...
        await axios({
            method: 'get',
            url: 'https://uat.onplanapp.com/api/dashboard/getAllDashboards',
            headers:{
                'Accept': 'application/json',
                'Authorization' : getAccessToken,
              },
    ...
    handleUpdateDashboardName = async () => {
        ...
        await axios({
            method: 'post',
            url: (`https://uat.onplanapp.com/api/dashboard/renameDashboardName`),
